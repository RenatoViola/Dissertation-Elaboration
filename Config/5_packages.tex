...
\lstdefinestyle{csharp}{
  ...
  stepnumber=1,
  frame=single,
  tabsize=2, % Set tab size to 2 (this reduces indentation of each tab)
  xleftmargin=0pt, % Remove the left margin
  xrightmargin=0pt, % Remove the right margin
  lineskip=0pt, % Adjust space between lines
}
