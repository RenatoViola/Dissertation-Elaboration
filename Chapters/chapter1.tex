...
\begin{itemize}
  ...
  \item An APK (Android Package Kit) for Android enabling BVI users to explore artworks through immersive 3D audio, providing an experience that is both aesthetic and informational while promoting independence with simple controls.
