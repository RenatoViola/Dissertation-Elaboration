...
\begin{itemize}
  \item An intuitive \gls{3D} auditory environment creation tool for museum curators to create spatial audio environments representing art pieces, requiring no prior expertise in audio design.
