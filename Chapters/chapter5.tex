...
A total of eight participants took part in the evaluation of the mobile soundscape player. None of them had been previously exposed to the application or its functionalities, ensuring that their feedback reflected first-time user impressions rather than prior familiarity. Table~\ref{tab:hla:mobile-user-characterization} characterizes the participants.

Participants’ ages ranged from 28 to 56 years old, with an average of 42.5 years. The subject sample was relatively balanced across middle adulthood, though no participants under 25 or above 60 were included.
\bgroup
